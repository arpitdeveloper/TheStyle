...
import { applyOptionsForRTDB, pluckResultFields, wrap, unwrap } from '@flamelink/sdk-utils';
...
var factory = function (context) {
    var api = {
        ...
        getRaw: function (_a) {
            ...
            return applyOptionsForRTDB(api.ref(settingsKey), options).once(options.event || 'value');
        },
        get: function (_a) {
            var settingsKey = _a.settingsKey, options = __rest(_a, ["settingsKey"]);
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            result = _b.sent();
                            return [2, options.needsWrap ? unwrap(settingsKey, result) : result];
                    }
                });
            });
        },
        ...
        subscribeRaw: function (_a) {
            ...
            var filteredRef = applyOptionsForRTDB(api.ref(settingsKey), options);
